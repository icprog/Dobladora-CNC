            ...
            if (dir != "openFileDialog1")
            {
                ...
                while ((linea = archivoGcode.ReadLine()) != null)
                {
                    if (linea != "")
                    {
                        ...
                        if (bx.Success)
                        {
                            ...
                            if (key != null)
                            {
                                x1 = Math.Round(Convert.ToDouble(key), 2);
                            }
                        }
                        if (by.Success)
                        {
                            ...
                            if (key != null)
                            {
                                y1 = Math.Round(Convert.ToDouble(key), 2);
                            }
                        }
                        if (planoCorte)
                        {
                ...
                foreach (nodo n in lista_nodos)
                {
                    ...
                    else
                    {
                        ...
                        /*//
                        Agregar codigo para verificar distancias y angulos y clasificar circunferencias. 
                        ///*/
